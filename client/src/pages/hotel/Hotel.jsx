...
const Hotel = ({ getHotel, data, search }) => {
          ...
          <div className="hotelWrapper">
            ...
            <div className="hotelDetails">
              ...
              <div className="hotelDetailsPrice">
                ...
                <h2>
                  <b>
                    ${days * data?.hotel?.cheapestPrice * options?.room || 0}
                  </b>{" "}
                  ({days} nights)
                </h2>
...
const mapState = (state) => ({
  data: state.hotel,
  search: state.hotels.search,
});

const mapDispatch = (dispatch) => ({
  getHotel: (hotelId) => dispatch.hotel.getHotel(hotelId),
});
